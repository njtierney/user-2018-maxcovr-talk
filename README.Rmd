...
This talk drew upon publicly available datasets from the Brisbane government - from https://www.data.brisbane.qld.gov.au/. The datasets were initially suggested by friendly folks from the Stories with Data Slack channel, 
